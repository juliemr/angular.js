...
window.it = wrapInControlFlow(window.it);
window.beforeEach = wrapInControlFlow(window.beforeEach);
window.afterEach = wrapInControlFlow(window.afterEach);
